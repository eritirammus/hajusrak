...
<template>
    <div>
        <div class="min-h-screen ">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :active="route().current('maps.index')" :href="route('maps.index')">
                                    Map
                                </NavLink>
                                <NavLink :active="route().current('weather')" :href="route('weather')">
                                    Weather
                                </NavLink>
                                <NavLink :active="route().current('ralf')" :href="route('ralf')">
                                    Movies
                                </NavLink>
                                <NavLink :active="route().current('products')" :href="route('products')">
                                    Add Products
                                </NavLink>
                                <NavLink :active="route().current('store')" :href="route('store')">
                                    Store
                                </NavLink>
                                <NavLink :active="route().current('cart')" :href="route('cart')">
                                    Cart
                                </NavLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4">
                            ...
                            <div class="font-medium text-xl text-gray-200">{{ $page.props.auth.user.email }}</div>
                        </div>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="bg-white-100 shadow">
